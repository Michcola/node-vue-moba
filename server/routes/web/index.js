module.exports = app => {
  ...
  router.get('/heroes/list', async (req, res) => {
    ...
    const cats = await Category.aggregate([ //聚合查询(非常强大)
      { $match: { parent: parent._id } },
      {
        $lookup: {
          from: 'heroes',
